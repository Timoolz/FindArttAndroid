...
//        responseCall = FindArttRepository.signUpGoogle(new TokenInfo(account.getIdToken()));
//        responseCall.enqueue(new Callback<FindArttResponse<UserResult>>() {
//
//            @Override
//            public void onResponse(Call<FindArttResponse<UserResult>> call, MVResponse<FindArttResponse<UserResult>> response) {
...
//        responseCall = FindArttRepository.signUp(signup);
//        responseCall.enqueue(new Callback<FindArttResponse<UserResult>>() {
//
//            @Override
//            public void onResponse(Call<FindArttResponse<UserResult>> call, MVResponse<FindArttResponse<UserResult>> response) {
