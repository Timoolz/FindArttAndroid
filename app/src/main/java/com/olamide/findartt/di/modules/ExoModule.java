...
import static com.olamide.findartt.AppConstants.EXO_PLAYER_USER_AGENT;
import static com.olamide.findartt.AppConstants.EXO_PLAYER_VIDEO_CACHE_DURATION;
...
public class ExoModule {
    ...
    @Singleton
    @Provides
    public String provideUserAgent(@NonNull Application application) {
        return Util.getUserAgent(application, EXO_PLAYER_USER_AGENT);
    }
    ...
    @Reusable
    @Provides
    public DefaultRenderersFactory provideDefaultRenderersFactory(@NonNull Application application) {
     ...
     */
    @Provides
    public SimpleExoPlayer provideExoPlayer(@NonNull Application application,
        ...
        SimpleExoPlayer exoPlayer = ExoPlayerFactory.newSimpleInstance(application, renderersFactory, trackSelector, loadControl);
    ...
    @Reusable
    @Provides
    public DefaultDataSourceFactory provideDefaultDataSourceFactory(@NonNull Application application,
                                                                    @NonNull DefaultBandwidthMeter bandwidthMeter,
                                                                    @NonNull HttpDataSource.Factory factory) {
        return new DefaultDataSourceFactory(application, bandwidthMeter, factory);
    }
    ...
    public LeastRecentlyUsedCacheEvictor provideLeastRecentlyUsedCacheEvictor() {
        return new LeastRecentlyUsedCacheEvictor(EXO_PLAYER_VIDEO_CACHE_DURATION);
    }
...
//    }
    ...
    @Singleton
    @Provides
    public SimpleCache provideSimpleCache(@NonNull Application application, @NonNull LeastRecentlyUsedCacheEvictor evictor) {
        return new SimpleCache(new File(application.getCacheDir(), application.getString(R.string.cache_type)), evictor);
    }
    ...
    public CacheDataSink provideCacheDataSink(@NonNull SimpleCache simpleCache) {
        return new CacheDataSink(simpleCache, EXO_PLAYER_VIDEO_CACHE_DURATION);
    }
