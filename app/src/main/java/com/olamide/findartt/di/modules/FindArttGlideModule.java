...
import static com.olamide.findartt.AppConstants.GLIDE_DEFAULT_TIMEOUT;

/**
 * A FindArttGlideModule for this app to manage all Glide structures in a single place
 * This will give the same impact on all Glide.
 *
 * @author nuhkoca
 */
@GlideModule(glideName = "FindArttGlide")
@Excludes(value = {OkHttpLibraryGlideModule.class})
public final class FindArttGlideModule extends AppGlideModule {
    ...
    public void registerComponents(@NonNull Context context, @NonNull Glide glide, @NonNull Registry registry) {
        OkHttpClient client = new OkHttpClient.Builder()
                .readTimeout(GLIDE_DEFAULT_TIMEOUT, TimeUnit.SECONDS)
                .connectTimeout(GLIDE_DEFAULT_TIMEOUT, TimeUnit.SECONDS)
                .build();
