...
//
//        responseCall = FindArttRepository.findArt(accessToken);
//        responseCall.enqueue(new Callback<FindArttResponse<List<Artwork>>>() {
//
//            @Override
//            public void onResponse(Call<FindArttResponse<List<Artwork>>> call, MVResponse<FindArttResponse<List<Artwork>>> response) {
