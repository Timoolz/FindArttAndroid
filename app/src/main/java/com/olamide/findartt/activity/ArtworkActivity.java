...
//
//
//        responseCall = FindArttRepository.getArtSummary(accessToken, artwork.getId());
//        responseCall.enqueue(new Callback<FindArttResponse<ArtworkSummary>>() {
//
//            @Override
//            public void onResponse(Call<FindArttResponse<ArtworkSummary>> call, MVResponse<FindArttResponse<ArtworkSummary>> response) {
//
//
